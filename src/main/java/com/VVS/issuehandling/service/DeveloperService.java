...
import com.VVS.issuehandling.convertors.DeveloperConvertor;
...
import com.VVS.issuehandling.repo.DeveloperRepository;
...
public class DeveloperService {
    ...
    public DeveloperOut create(DeveloperIn developerIn)  {
        Module moduleExisting = moduleRepository.findById(developerIn.getModuleId()).orElseThrow(()->
                new NotFondException(Module.class, developerIn.getModuleId()));
    ...
    public DeveloperOut findById(Long developerId) {
            Developer developer1 = developerRepository.findById(developerId).orElseThrow(()
                    -> new NotFondException(Developer.class, developerId));
